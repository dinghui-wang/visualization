...
const setScale = object => {
    const bbox = new THREE.Box3().setFromObject(object) // 获取模型的包围盒
...
// 设置相机
const camera = new THREE.PerspectiveCamera(45, innerWidth / innerHeight, 10, 1000)
...
renderer.setClearColor('#FFF', 0.5)
